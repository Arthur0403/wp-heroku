                    ...
                    <div id="redux-add-widget" class="widgets-holder-wrap">
                        <div class="">
                            ...
                            <div class="sidebar-name">
                                <h3><?php echo esc_html__( 'Create Widget Area', 'engage' ); ?> <span
                                ...
                                <form id="addWidgetAreaForm" action="" method="post">
                                    <div class="widget-content">
                                        <input id="redux-add-widget-input" name="redux-add-widget-input" type="text"
                                               class="regular-text"
                                               title="<?php echo esc_html__( 'Name', 'engage' ); ?>"
                                               placeholder="<?php echo esc_html__( 'Name', 'engage' ); ?>"/>
                                    </div>
                                    <div class="widget-control-actions">
                                        <div class="aligncenter">
                                            <input class="addWidgetArea-button button-primary" type="submit"
                                                   value="<?php echo esc_html__( 'Create Widget Area', 'engage' ); ?>"/>
                                        </div>
                                        <br class="clear">
                                    </div>
                                </form>
            ...
            function _enqueue() {
                ...
                wp_localize_script(
                    ...
                    array(
                        ...
                        'delete'	=> esc_html__( 'Delete', 'engage' ),
                        'confirm'	=> esc_html__( 'Confirm', 'engage' ),
                        'cancel'	=> esc_html__( 'Cancel', 'engage' ),
                    )
                );
