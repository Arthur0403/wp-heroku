    ...
    if ( ! class_exists( 'ReduxFramework_social_profiles' ) ) {
        ...
        class ReduxFramework_social_profiles {
            ...
            public function __construct( $field = array(), $value = '', $parent ) {
                ...
                $file_name = 'social_profiles';
                $this->extension_url = ENGAGE_CORE_URI . '/theme-panel/extensions/' . $file_name . '/social_profiles/';
            ...
            public function render() {
                ...
                $msg      = isset( $this->field['widget_msg'] ) ? $this->field['widget_msg'] : esc_html__( 'Go to the <a href="%s">Widgets</a> page to add the Redux Social Widget to any active widget area.', 'engage' );
                ...
                foreach ( $this->defaults as $key => $social_provider_default ) {
                    ...
                    $label = ( $social_provider_option && array_key_exists( 'label', $social_provider_option ) && $social_provider_option['label'] ) ? $social_provider_option['label'] : esc_html__( 'Link URL', 'engage' ); //$social_provider_default[ 'name' ];
                ...
                />';
                    ...
                    $reset_text = esc_html__( 'Reset', 'engage' );
                    echo '<div class="redux-social-profiles-item-reset">';
                    echo '<a class="button" data-value="' . $key . '" value="' . $reset_text . '" />' . $reset_text . '</a>';
                    echo '</div>';

                    if ($color_pickers) {
                        $label = apply_filters('redux/extensions/social_profiles/' . $this->opt_name . '/color_picker/text', esc_html__( 'Text', 'engage' ));
                        ...
                        $label = apply_filters('redux/extensions/social_profiles/' . $this->opt_name . '/color_picker/background', esc_html__( 'Background', 'engage' ));
