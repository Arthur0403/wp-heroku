...
(function( $ ) {
    ...
    redux.field_objects.multi_field = redux.field_objects.multi_field || {};
    ...
    redux.field_objects.multi_field.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.redux-container-multi_field:visible' );
        }
