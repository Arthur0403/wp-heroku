        ...
        class reduxCoreEnqueue {
            ...
            private function register_styles() {
                ...
                Redux_CDN::register_style(
                    'select2-css',
                    '//cd' . 'n.jsdelivr.net/select2/3.5.2/select2.css',
                    array(),
            ...
            private function register_scripts() {
                ...
                Redux_CDN::register_script(
                    'select2-js',
                    '//cd' . 'n.js' . 'delivr.net/select2/3.5.2/select2' . $this->min . '.js',
                ...
                wp_enqueue_script(
                    'webfontloader',
                    'https://aja' . 'x.goog' . 'leapis.com/ajax/libs/webfont/1.5.0/webfont.js',
                    array( 'jquery' ),
                    '1.5.0',
                    true
                );
            ...
            private function set_localized_data() {
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/save_pending", esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'engage' ) );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset", esc_html__( 'Are you sure? Resetting will lose all custom values.', 'engage' ) );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset_section", esc_html__( 'Are you sure? Resetting will lose all custom values in this section.', 'engage' ) );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/preset", esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'engage' ) );
                 ...
                 */
                $import_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/import", esc_html__( 'Your current options will be replaced with the values of this import. Would you like to proceed?', 'engage' ) );
                ...
                $this->parent->localize_data['args'] = array(
                    ...
                    'please_wait'           => esc_html__( 'Please Wait', 'engage' ),
                ...
                $this->parent->localize_data['ajax'] = array(
                    'console' => esc_html__( 'There was an error saving. Here is the result of your action:', 'engage' ),
                    'alert'   => esc_html__( 'There was a problem with your action. Please try again or reload the page.', 'engage' ),
                );
