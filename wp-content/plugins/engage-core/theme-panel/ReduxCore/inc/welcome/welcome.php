<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo esc_html__( 'If you like <strong>Redux</strong> please leave us a <a href="https://wordpress.org/support/view/plugin-reviews/redux-framework?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. A huge thank you from Redux in advance!', 'engage' );
        }
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'engage' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'engage' ), esc_html__( 'Redux Framework', 'engage' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'engage' ), esc_html__( 'Redux Framework Changelog', 'engage' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'engage' ), esc_html__( 'Get Support', 'engage' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'engage' ), esc_html__( 'Redux Extensions', 'engage' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'engage' ), esc_html__( 'The people that develop Redux Framework', 'engage' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'engage' ), esc_html__( 'Redux Framework Status', 'engage' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php if ( $selected == 'redux-about' ) echo 'nav-tab-active'; ?>"
                    href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-about' ), 'tools.php' ) ) ); ?>">
                    <?php esc_attr_e( "What's New", 'engage' ); ?>
                </a> <a class="nav-tab <?php if ( $selected == 'redux-extensions' ) echo 'nav-tab-active'; ?>"
                    href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-extensions' ), 'tools.php' ) ) ); ?>">
                    <?php esc_attr_e( 'Extensions', 'engage' ); ?>
                </a> <a class="nav-tab <?php if ( $selected == 'redux-changelog' ) echo 'nav-tab-active'; ?>"
                    href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-changelog' ), 'tools.php' ) ) ); ?>">
                    <?php esc_attr_e( 'Changelog', 'engage' ); ?>
                </a> <a class="nav-tab <?php if ( $selected == 'redux-credits' ) echo 'nav-tab-active'; ?>"
                    href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-credits' ), 'tools.php' ) ) ); ?>">
                    <?php esc_html_e( 'Credits', 'engage' ); ?>
                </a> <a class="nav-tab <?php if ( $selected == 'redux-support' ) echo 'nav-tab-active'; ?>"
                    href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-support' ), 'tools.php' ) ) ); ?>">
                    <?php esc_attr_e( 'Support', 'engage' ); ?>
                </a> <a class="nav-tab <?php if ( $selected == 'redux-status' ) echo 'nav-tab-active'; ?>"
                    href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-status' ), 'tools.php' ) ) ); ?>">
                    <?php esc_attr_e( 'Status', 'engage' ); ?>
                </a>
            </h2>
            <?php
        }
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( esc_html__( 'View %s', 'engage' ), esc_html( $contributor->login ) ) )
                );
