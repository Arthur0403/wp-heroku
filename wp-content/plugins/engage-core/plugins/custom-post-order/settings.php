...
<div class="wrap">
    ...
    <h2><?php esc_html_e('Simple Custom Post Order Settings', 'scporder'); ?></h2>
    <?php if (isset($_GET['msg'])) : ?>
        <div id="message" class="updated below-h2">
            <?php if ($_GET['msg'] == 'update') : ?>
                <p><?php esc_html_e('Settings Updated.','scporder'); ?></p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <form method="post">
        ...
        <div id="scporder_select_objects">
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <th scope="row"><?php esc_html_e('Check to Sort Post Types', 'scporder') ?></th> 
                        <td>
                            <label><input type="checkbox" id="scporder_allcheck_objects"> <?php esc_html_e('Check All', 'scporder') ?></label><br>
                            <?php
        ...
        <div id="scporder_select_tags">
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <th scope="row"><?php esc_html_e('Check to Sort Taxonomies', 'scporder') ?></th> 
                        <td>
                            <label><input type="checkbox" id="scporder_allcheck_tags"> <?php esc_html_e('Check All', 'scporder') ?></label><br>
                            <?php
        ...
        <p class="submit">
            <input type="submit" class="button-primary" name="scporder_submit" value="<?php esc_html_e('Update', 'scporder'); ?>">
        </p>
