...
<body <?php body_class(); ?>>
    ...
    if ( ! is_page_template( 'template-blank.php' ) ) {
        ...
        if ($header_position == 'top') {
            ...
            <header id="header" class="<?php engage_header_classes(); ?>"
                    data-scroll-height="<?php engage_header_scroll_height(); ?>"
                    data-scroll-animation="<?php engage_header_scroll_animation(); ?>"
                    data-skin="<?php echo esc_attr(engage_header_skin()); ?>"
                    data-scroll-skin="<?php echo esc_attr(engage_header_scroll_skin()); ?>"<?php if ($data_sticky_amount != '') echo ' data-scroll-amount="' . esc_attr($data_sticky_amount) . '"'; ?>>
                ...
                if ($header_style == 'top-logo' || $header_style == 'top-logo-center') {
                    ...
                    <div id="main-navigation"
                         class="main-nav bottom-nav"<?php if ($header_color != '') echo ' style="background-color:' . esc_attr($header_color) . ';"'; ?>>
                        ...
                        <div class="bottom-nav-wrapper">
                            <div class="container<?php echo esc_attr($container_classes); ?>">
                                <nav id="main-menu"
                                     class="main-menu<?php if ($header_style == 'overlay-simple') echo ' off-main-menu'; ?>">
                                    <?php
                                    engage_nav_menu();
                                    engage_nav_tools();
                                    ?>
                    ...
                    <div id="main-navigation"
                         class="main-nav"<?php if ($header_color != '') echo ' style="background-color:' . esc_attr($header_color) . ';"'; ?>>
                ...
                <nav id="mobile-nav" class="mobile-nav">
                    <div class="container">
                        ...
                        engage_nav_menu( $mobile_nav_style, true );
  ...
  do_action( 'engage_before_main_content' );
    ...
    do_action( 'engage_before_page_title_area' );

	if ( ! is_page_template( 'template-blank.php' ) && engage_option( 'header_title' ) != 0 && get_post_meta( engage_get_id(), "custom_pagetitle", TRUE ) != 'disable' || !class_exists( 'Engage_Core' ) || engage_option( 'header_title' ) == null ) {
	    if ( is_search() && engage_option('search_page_title') == 0 || is_archive() && engage_option('search_page_title') == 0 || class_exists( 'WooCommerce' ) && is_product() && engage_option( 'wc_product_page_title' ) == '0' ) {} else {
