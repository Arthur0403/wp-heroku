...
if ( engage_option( 'footer_widgets' ) == '0' ) {
...
if ( engage_option( 'footer_enabled' ) == '0' ) {
...
?>
    ...
    do_action( 'engage_before_footer_area' );

    if ( ! is_page_template( 'template-blank.php' ) && ( $footer_enabled || $footer_widgets ) ) { ?>
	...
	<footer id="footer" class="footer">
        ...
        do_action( 'engage_before_footer_widgets' );
      ...
      case '1col':
        ...
        do_action( 'engage_before_footer_bottom_bar' );
				...
				<div class="row f-bottom">
					...
					<div class="<?php echo esc_attr( $copyright_container_class ); ?>">
						...
						if ( engage_option( 'copyright' ) ) {
							...
							$copyright_text = engage_option( 'copyright' );
							...
							echo wp_kses( $copyright_text, engage_kses() );

						} elseif ( !class_exists( 'Engage_Core' ) || engage_option( 'copyright' ) == null ) {
							$copyright_text = esc_html__( 'Copyright 2018 My Website', 'engage' );
							if ( strpos( $copyright_text, '{year}' ) !== false) {
								$current_year = date("Y");
								$copyright_text = str_replace( '{year}', $current_year, $copyright_text );
							}
						...
						do_action( 'engage_copyright_text_after' );

						?>
						</p>
						<?php do_action( 'engage_copyright_after' ); ?>
					</div>
    ...
    do_action( 'engage_after_footer_area' );
